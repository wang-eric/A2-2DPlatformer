...
public class CloudFlipController : MonoBehaviour {
	...
	private void _flip() {
		if (this._isFacingRight) {
			this._transform.localScale = new Vector3(3.5f, 3.5f, 1f); // reset to normal scale
		} else {
			this._transform.localScale = new Vector3(-3.5f, 3.5f, 1f);
		}
	}
